          ...
          >
            ...
            <Heading color="yellow" size="sm">
              ...
              <InfoPopover ariaLabel="Why ICGPT is the OG of on-chain LLMs">
                ...
                <br />
                <br />
                The LLM runs entirely inside Internet Computer canisters. There
                is no API call to an off-chain model anywhere: the weights live
                in the canister&apos;s stable memory, and every token is
                generated by on-chain compute.
                <br />
                <br />
                Prompt caching also happens in the canister, in stable memory,
                and every user gets their own isolated cache. Each turn re-uses
                what the LLM has already processed instead of re-reading the
                whole conversation, which saves compute and makes longer chats
                possible.
                <br />
                <br />
                <a
